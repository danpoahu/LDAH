...
(function (global) {
  ...
  /* ------------------------------------------------------------------ *
   * Shared LDAH phone formatter contract — IDENTICAL across all products.
   * Window-scoped so inline <script> blocks on every page can call them.
   * ------------------------------------------------------------------ */
  ...
  // Attach live formatting to a phone <input>.
